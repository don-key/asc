...
<div id="page-wrapper">
   <div class="row">
      <div class="col-lg-12">
        <br> <img alt="" src="/resources/images/header/help.png" style="margin-left: auto; margin-right: auto; display: block; width: 20%">
      </div>
   </div>
   <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#community" data-toggle="tab" style="color:black">커뮤니티</a>
                                </li>
                                <li><a href="#log" data-toggle="tab" style="color:black">수정사항</a>
                                </li>
                            </ul>
