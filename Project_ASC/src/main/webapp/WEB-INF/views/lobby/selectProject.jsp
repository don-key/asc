   ...
   <c:choose>
      ...
      <c:otherwise>
         <c:forEach items="${list}" var="projectList" varStatus="status">
            ...
            <a href="/project/dashBoard?projectListNo=${projectList.projectListNo }&userNo=${login.userNo}" class="thumbnail"> <img src="/resources/images/upload${projectList.projectPhoto}" alt="">
               </a>
               <div class="panel">
