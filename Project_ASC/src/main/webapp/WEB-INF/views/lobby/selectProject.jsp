        ...
        <div class="panel-heading">
          <div class="row">
            <div class="text-center" style="font-size: 20%;">
              <a id="newProject" class="btn btn-default btn-lg" data-toggle="modal"
                data-target="#createProjectModal"> 새 프로젝트　<i
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-xs-4">
      ...
      <div class="panel">
        ...
        <a href="#" id="modifyIcon" class="fa fa-pencil" data-toggle="modal" data-target="#modifyProjectModal">수정</a>
          <a href="#" id="deleteIcon" class="fa fa-trash-o">삭제</a>
        </div>
      </div>
    </div>
