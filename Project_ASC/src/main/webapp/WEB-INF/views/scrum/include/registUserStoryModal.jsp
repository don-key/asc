    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            <input type="text" name="userStoryTitle" style="width: 100%;" placeholder="내용을 입력해주세요.">
          </div>
        </div>
        <br>
        <div class="row">
          ...
          <div class="col-xs-8">
            <input type="text" name="userStoryAsA" style="width: 100%;" placeholder="내용을 입력해주세요.">
          </div>
        </div>
        <br>
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            <textarea name="userStoryIWant" style="width: 100%; height: 115px;" placeholder="내용을 입력해주세요."></textarea>
          </div>
        </div>
        <br>
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            <textarea name="userStorySoThat" style="width: 100%; height: 115px;" placeholder="내용을 입력해주세요."></textarea>
          </div>
        </div>
        <br>
