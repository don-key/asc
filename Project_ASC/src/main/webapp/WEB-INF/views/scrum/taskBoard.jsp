...
<link
  href="${pageContext.servletContext.contextPath}/resources/css/scrum.css"
  rel="stylesheet">
    ...
    <div class="panel panel-gray">
        <div class="panel-heading">
          ...
          <div class="col-xs-6 text-left">
              <div class="content">&nbsp;<p class="fa fa-pencil"></p></div>
            </div>
            <div class="col-xs-6 text-right">
              <div class="content"><span class="fa fa-trash-o"></span>&nbsp;</div>
            </div>
            <div class="col-xs-10 col-xs-offset-1 text-center">
